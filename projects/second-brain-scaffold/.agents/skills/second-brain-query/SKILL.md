...
6. Ignore `CLAUDE.md`, `AGENTS.md`, `GEMINI.md`, `.claude/**`, `.agents/**`, `.gemini/**`, `.claudian/**`, `.workflows/**`, `.brv/**`, `.obsidian/**`, `templates/**`, `raw/**`, and deprecated scaffold paths as answer sources. Raw files are provenance/evidence/instructional visual attachments, not query answer nodes.
